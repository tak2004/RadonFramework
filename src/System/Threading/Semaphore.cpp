...
void* SemaImplementationInit(RF_Type::UInt32 value)
{
...
{
  DWORD state =
      WaitForSingleObject(*static_cast<HANDLE*>(Data), timeout.Milliseconds());
  return state == 0;
}
#endif
...
Semaphore::Semaphore(RF_Type::UInt32 value)
{
...
RF_Type::Bool Semaphore::TimedWait(const TimeSpan& timeout)
{
