...
public:
    ...
    RF_Type::Size m_Cores;
    RF_Type::Size m_Threads;
...
void WorkBalancer::Configure(const RF_Type::UInt32 HardwareHash, 
    const RF_Type::Size Cores, const RF_Type::Size Threads /*= 0*/)
{
    m_PImpl->m_Cores = Cores;
    m_PImpl->m_Threads = Threads ? Threads : Cores;
    m_PImpl->m_HardwareHash = HardwareHash;
}

void WorkBalancer::Configure(const RF_Type::UInt32 HardwareHash, 
    const RF_Type::Size Cores, const Configuration& NewConfiguration)
{

}

void WorkBalancer::BalancePerCore(const RF_Type::Size Tasks, PerCoreBucketList& Buckets) const
{

}

void WorkBalancer::BalanceForPool(const RF_Type::Size Tasks, BucketList& Buckets) const
{
