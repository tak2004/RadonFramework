...
{
  return Interlocked::InterlockedInc32(reinterpret_cast<Int32*>(&m_Data));
}

AtomicUInt32::DataType AtomicUInt32::Decrement()
{
  return Interlocked::InterlockedDec32(reinterpret_cast<Int32*>(&m_Data));
}

AtomicUInt32::DataType AtomicUInt32::FetchAndAdd(DataType Addend)
{
  return Interlocked::InterlockedAdd32(reinterpret_cast<Int32*>(&m_Data),
                                       Addend);
}

AtomicUInt32::DataType AtomicUInt32::FetchAndExchange(DataType Value)
{
  return Interlocked::InterlockedExchange32(reinterpret_cast<Int32*>(&m_Data),
                                            Value);
}
...
{
  return Interlocked::InterlockedCompareExchange32(
      reinterpret_cast<Int32*>(&m_Data), Value, Compare);
}
