...
{
  return Interlocked::InterlockedInc16(reinterpret_cast<Int16*>(&m_Data));
}

AtomicUInt16::DataType AtomicUInt16::Decrement()
{
  return Interlocked::InterlockedDec16(reinterpret_cast<Int16*>(&m_Data));
}

AtomicUInt16::DataType AtomicUInt16::FetchAndAdd(DataType Addend)
{
  return Interlocked::InterlockedAdd16(reinterpret_cast<Int16*>(&m_Data),
                                       Addend);
}

AtomicUInt16::DataType AtomicUInt16::FetchAndExchange(DataType Value)
{
  return Interlocked::InterlockedExchange16(reinterpret_cast<Int16*>(&m_Data),
                                            Value);
}
...
{
  return Interlocked::InterlockedCompareExchange16(
      reinterpret_cast<Int16*>(&m_Data), Value, Compare);
}
