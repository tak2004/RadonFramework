...
Radon::Radon(UInt32 Flags)
{
    ...
    if (!m_IsInitialized)
    {
        ...
        if (Flags & RadonFramework::Init::SMBios)
        {
            #ifdef RF_WINDOWS
            ...
            m_PIMPL->m_IsSubSystemInitialized&=RadonFramework::Init::SMBios;
        }
...
Radon::~Radon()
{
    if (m_IsInitialized)
    {
        ...
        if (m_PIMPL->m_IsSubSystemInitialized & RadonFramework::Init::SMBios)
        {
