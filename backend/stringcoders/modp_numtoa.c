...
#include <RadonFramework/backend/stringcoders/modp_numtoa.h>
 ...
 * 10^0 to 10^9
 */
static const double MODP_POW10[] = {1, 10, 100, 1000, 10000, 100000, 1000000,
...
void modp_dtoa(double value, char* str, int prec)
{
    ...
    int whole = (int) value;
    double tmp = (value - whole) * MODP_POW10[prec];
