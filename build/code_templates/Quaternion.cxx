...
{
  @ClassType@ a =
      RF_Math::@MathType@::DegToRad(Alpha * static_cast<@ClassType@>(0.5));
  RF_ASSERT(Direction.Length() >= RF_Math::@MathType@::EPSILION,
         "Invalid parameter.");
...
@ClassName@::@ClassName@(const @ClassType@ w,
                         const @ClassType@ X,
                         const @ClassType@ Y,
                         const @ClassType@ Z)
{
...
@ClassName@::@ClassName@(const Matrix<@ClassType@, 3, 3>& RotationMatrix)
{
  ...
  if(tr >= 0.0)
  {
    s = RF_Math::@MathType@::Sqrt(tr + static_cast<@ClassType@>(1)) *
        static_cast<@ClassType@>(2);
...
@ClassName@::@ClassName@(const @ClassType@ Roll, const @ClassType@ Pitch,
                         const @ClassType@ Yaw)
{
  @ClassType@ r =
      RF_Math::@MathType@::DegToRad(Roll * static_cast<@ClassType@>(0.5));
  @ClassType@ p =
      RF_Math::@MathType@::DegToRad(Pitch * static_cast<@ClassType@>(0.5));
  @ClassType@ y =
      RF_Math::@MathType@::DegToRad(Yaw * static_cast<@ClassType@>(0.5));
...
@ClassName@& @ClassName@::Invert()
{
  ...
  RF_ASSERT(val != static_cast<@ClassType@>(0.0), "Invalid value.");
  Conjugate().m_Vec /= val;
  return *this;
}
...
{
  @ClassName@ result;
  @ClassType@ angle = RF_Math::@MathType@::Sqrt(m_Vec[1] * m_Vec[1] + m_Vec[2] * m_Vec[2] + m_Vec[3] * m_Vec[3]);
...
void @ClassName@::ToAxisAngle(Vector<@ClassType@, 3>& Axis,@ClassType@& Angle)
{
  ...
  Angle = RF_Math::@MathType@::RadToDeg(
      static_cast<@ClassType@>(2) * RF_Math::@MathType@::ACos(m_Vec[0]));
