...
public:
    ...
    RF_Type::Bool ConstrainedCopy(RF_Type::Size SourceIndex,
        BitArray<RB, MA, MO>& DestinationArray, RF_Type::Size DestinationIndex,
        RF_Type::Size Length);
     ...
     *               the number of elements to copy.
     */
    RF_Type::Bool ConstrainedCopy(BitArray<RB, MA, MO>& DestinationArray,
        RF_Type::Size Length);
     ...
     *               the number of elements to copy.
     */
    void Copy(RF_Type::Size Index, BitArray<RB, MA, MO>& DestinationArray,
        RF_Type::Size DestinationIndex, RF_Type::Size Length);
...
Memory::AutoPointer<BitArray<RB, MA, MO> > BitArray<RB, MA, MO>::CreateInstance(
    const RF_Type::UInt8 CArray[], const RF_Type::Size Length)
{
...
template<typename RB, typename MA, typename MO>
RF_Type::Bool BitArray<RB, MA, MO>::ConstrainedCopy(RF_Type::Size SourceIndex,
    BitArray<RB, MA, MO>& DestinationArray, RF_Type::Size DestinationIndex,
    RF_Type::Size Length)
{
...
template<typename RB, typename MA, typename MO>
RF_Type::Bool BitArray<RB, MA, MO>::ConstrainedCopy(
...
template<typename RB, typename MA, typename MO>
void BitArray<RB, MA, MO>::Copy(RF_Type::Size Index, BitArray<RB, MA, MO>& DestinationArray,
    RF_Type::Size DestinationIndex, RF_Type::Size Length)
{
