...
template <class ALLOCATOR,
          RF_Type::Size BLOCK_SIZE,
          RF_Type::Size BLOCK_ALIGN_SIZE>
RF_Type::Bool LinearAllocator<ALLOCATOR, BLOCK_SIZE, BLOCK_ALIGN_SIZE>::Owns(
    const MemoryBlock& Block) const
{
  return (Block.Data >= m_Pool.Data) &&
         (m_Pool.Data + m_Pool.Bytes < Block.Data);
}

template <class ALLOCATOR,
          RF_Type::Size BLOCK_SIZE,
          RF_Type::Size BLOCK_ALIGN_SIZE>
void LinearAllocator<ALLOCATOR, BLOCK_SIZE, BLOCK_ALIGN_SIZE>::Deallocate(
...
template <class ALLOCATOR,
          RF_Type::Size BLOCK_SIZE,
          RF_Type::Size BLOCK_ALIGN_SIZE>
MemoryBlock LinearAllocator<ALLOCATOR, BLOCK_SIZE, BLOCK_ALIGN_SIZE>::Allocate(
