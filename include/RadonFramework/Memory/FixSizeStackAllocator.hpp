...
RF_Type::Size
FixSizeStackAllocator<SIZE, ALIGN_SIZE>::RoundToNextAligned(RF_Type::Size Bytes)
{
...
template <RF_Type::Size SIZE, RF_Type::Size ALIGN_SIZE>
void FixSizeStackAllocator<SIZE, ALIGN_SIZE>::Deallocate(
...
template <RF_Type::Size SIZE, RF_Type::Size ALIGN_SIZE>
RF_Type::Bool
FixSizeStackAllocator<SIZE, ALIGN_SIZE>::Owns(const MemoryBlock& Block) const
{
...
template <RF_Type::Size SIZE, RF_Type::Size ALIGN_SIZE>
MemoryBlock
FixSizeStackAllocator<SIZE, ALIGN_SIZE>::Allocate(const RF_Type::Size Bytes)
{
