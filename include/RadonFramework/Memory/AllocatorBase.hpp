...
{
public:
    virtual void* Allocate(const RF_Type::Size Bytes, const RF_Type::UInt32 Flag = 0)=0;
    ...
    virtual void* ResizeOrAllocate(void* Pointer, const RF_Type::Size NewSize) = 0;
    ...
    virtual RF_Type::Size GetUsedBytes()const = 0;
    /// Return the amount of bytes which the smallest allocation can handle.
    virtual RF_Type::Size GetAllocationGranularity()const = 0;
};
