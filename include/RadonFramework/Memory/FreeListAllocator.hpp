...
template <class ALLOCATOR,
          RF_Type::Size BLOCK_SIZE,
          RF_Type::Size BLOCK_ALIGN_SIZE>
RF_Type::Bool FreeListAllocator<ALLOCATOR, BLOCK_SIZE, BLOCK_ALIGN_SIZE>::Owns(
...
template <class ALLOCATOR,
          RF_Type::Size BLOCK_SIZE,
          RF_Type::Size BLOCK_ALIGN_SIZE>
void FreeListAllocator<ALLOCATOR, BLOCK_SIZE, BLOCK_ALIGN_SIZE>::Deallocate(
    MemoryBlock& Block)
{
...
template <class ALLOCATOR,
          ...
          RF_Type::Size BLOCK_ALIGN_SIZE>
MemoryBlock
FreeListAllocator<ALLOCATOR, BLOCK_SIZE, BLOCK_ALIGN_SIZE>::Allocate(
