...
struct Float32
{
  ...
  ATan2(const RF_Type::Float32 X, const RF_Type::Float32 Y);
  ...
  static RF_Type::Float32
  FMod(const RF_Type::Float32 X, const RF_Type::Float32 Y);
  ...
  static RF_Type::Float32
  Min(const RF_Type::Float32 A, const RF_Type::Float32 B);
  static RF_Type::Float32
  Max(const RF_Type::Float32 A, const RF_Type::Float32 B);

  static RF_Type::Float32 Clamp(const RF_Type::Float32 Value,
                                const RF_Type::Float32 Min,
                                const RF_Type::Float32 Max);

  static RF_Type::Float32 Round(const RF_Type::Float32 Value);

  static RF_Type::Bool
  IsAlmostEqual(const RF_Type::Float32 a, const RF_Type::Float32 b);
  static RF_Type::Bool IsAlmostEqual(const RF_Type::Float32* a,
                                     const RF_Type::Float32* b,
