...
{
/** @brief This class represent a number generator, which produce a sequence of
 * random numbers.
 *
 ...
 * You can derive a new generator from this class and overload the Sample method
 * to change the random distribution or principle of the generator.
 */
class Random
{
public:
  ...
  virtual RF_Type::Int32
  Next(const RF_Type::Int32 MinValue, const RF_Type::Int32 MaxValue);
