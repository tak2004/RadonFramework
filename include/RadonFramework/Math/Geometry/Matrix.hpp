...
public:
    ...
    inline T& operator()(RF_Type::Size Col, RF_Type::Size Row)const
    {
        Assert(Col*M+Row>=0 && Col*M+Row<N*M,"Index out of bound.");
        return Value[Col*M+Row];
    }

    inline T& operator[](const RF_Type::Size Index)const
    {
...
public:
    ...
    inline T& operator()(RF_Type::Size Col, RF_Type::Size Row)
    {
    ...
    inline T& operator[](const RF_Type::Size Index)
    {
...
class Matrix<T,4,4>
{
    ...
    Matrix(const Matrix& Copy)
    {
        RadonFramework::System::Memory::Copy(Value, Copy.Value, sizeof(T)*16);
    }
    ...
    {
        RadonFramework::System::Memory::Copy(&Value[Column * 4], Vec.Value, sizeof(T) * 4);
    }
