...
struct Float64
{
  ...
  ATan2(const RF_Type::Float64 X, const RF_Type::Float64 Y);
  ...
  static RF_Type::Float64
  FMod(const RF_Type::Float64 X, const RF_Type::Float64 Y);
  ...
  static RF_Type::Float64
  Min(const RF_Type::Float64 A, const RF_Type::Float64 B);
  static RF_Type::Float64
  Max(const RF_Type::Float64 A, const RF_Type::Float64 B);

  static RF_Type::Float64 Clamp(const RF_Type::Float64 Value,
                                const RF_Type::Float64 Min,
                                const RF_Type::Float64 Max);

  static RF_Type::Float64 Round(const RF_Type::Float64 Value);

  static RF_Type::Bool
  IsAlmostEqual(const RF_Type::Float64 a, const RF_Type::Float64 b);
  static RF_Type::Bool IsAlmostEqual(const RF_Type::Float64* a,
                                     const RF_Type::Float64* b,
