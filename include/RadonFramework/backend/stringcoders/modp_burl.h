...
namespace modp {
    ...
    inline std::string url_encode(const char* s, size_t len)
    {
        ...
        int d = modp_burl_encode(const_cast<char*>(x.data()), s, static_cast<int>(len));
    ...
    inline std::string& url_min_encode(std::string& s)
    {
        ...
        int d = modp_burl_min_encode(const_cast<char*>(x.data()), s.data(), static_cast<int>(s.size()));
        x.erase(d, std::string::npos);
        s.swap(x);
        return s;
    }
    ...
    {
        int d = modp_burl_decode(const_cast<char*>(s.data()), s.data(), static_cast<int>(s.size()));
