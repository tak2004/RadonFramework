...
template <typename T>
AtomicPointer<T>::AtomicPointer(T* Value) : m_Data(Value)
{
}
...
T* AtomicPointer<T>::FetchAndExchange(T* Ptr)
{
  return reinterpret_cast<T*>(
      System::Threading::Interlocked::InterlockedExchangePointer(
...
{
  return reinterpret_cast<T*>(
      System::Threading::Interlocked::InterlockedCompareExchangePointer(
