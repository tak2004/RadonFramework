#ifndef RF_CORE_TYPES_STRINGPROCESSOR_HPP
#define RF_CORE_TYPES_STRINGPROCESSOR_HPP
#if _MSC_VER > 1000
#pragma once
#endif
...
public:
    ...
    */
    RF_Type::Bool Init(RF_Type::String& Text, const RF_Type::UInt32 Position, 
...
template<class StringProcessorPolicy>
RF_Type::Bool StringProcessor<StringProcessorPolicy>::Init(RF_Type::String& Text,
    const RF_Type::UInt32 Position, const RF_Type::Bool CopyText)
{
...
template<class StringProcessorPolicy>
void StringProcessor<StringProcessorPolicy>::Reset(const RF_Type::UInt32 Position)
{
...
#endif // RF_CORE_TYPES_STRINGPROCESSOR_HPP
