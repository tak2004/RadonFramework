...
namespace RadonFramework
{
    ...
    class Connection
    {
        ...
        protected:
            ...
            Collections::List<Event<>*> m_Events;
        public:
            ~Connection()
            {
                for (typename Collections::List<Event<>*>::Iterator it=m_Events.Begin();
                        it!=m_Events.End(); ++it)
    ...
    {
        protected:
            Collections::List<Connection<>*> m_Connections;
        public:
    ...
    {
        protected:
            Collections::List<Connection<_ARGU>*> m_EventHandler;
        public:
            ~Event()
            {
                for (typename Collections::List<Connection<_ARGU>*>::Iterator it=m_EventHandler.Begin();
