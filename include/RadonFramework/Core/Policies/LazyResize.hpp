...
struct LazyResizeTraits{ struct AllowedBlockSize; };

// 1 byte
template<>
struct LazyResizeTraits<8>{ struct AllowedBlockSize{}; };

// 2 byte
template<>
struct LazyResizeTraits<16>{ struct AllowedBlockSize{}; };

// 4 byte
template<>
struct LazyResizeTraits<32>{ struct AllowedBlockSize{}; };

// 8 byte
template<>
struct LazyResizeTraits<64>{ struct AllowedBlockSize{}; };
...
template<int BLOCKSIZE, int ELEMENTSIZEINBITS>
inline void LazyResize<BLOCKSIZE, ELEMENTSIZEINBITS>::Resize(Types::Size NewElementCount)
{
    elementCount=NewElementCount;
}

template<int BLOCKSIZE, int ELEMENTSIZEINBITS>
inline Types::Size LazyResize<BLOCKSIZE, ELEMENTSIZEINBITS>::BlockIndex(Types::Size ElementIndex)const
{
    return ElementIndex / BLOCKSIZE;
}

template<int BLOCKSIZE, int ELEMENTSIZEINBITS>
inline Types::Size LazyResize<BLOCKSIZE, ELEMENTSIZEINBITS>::BlockOffset(Types::Size ElementIndex)const
{
