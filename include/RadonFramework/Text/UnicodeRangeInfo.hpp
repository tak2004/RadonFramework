...
{
public:
  UnicodeRangeInfo() = default;
  UnicodeRangeInfo(const UnicodeRangeIdentifier Identifier,
...
protected:
  UnicodeRangeIdentifier m_Identifier = UnicodeRangeIdentifier::BasicLatin;
  RF_Type::UInt32 m_Start = 0;
  RF_Type::UInt32 m_End = 0x7f;
};
