#ifndef RF_TEXT_STRINGPROCESSORS_BRUTEFORCE_HPP
#define RF_TEXT_STRINGPROCESSORS_BRUTEFORCE_HPP
#if _MSC_VER > 1000
#pragma once
#endif
...
struct BruteForce
{
    ...
    **/
    ...
    /// Configure Storage.
    static RF_Type::Bool Init(RF_Type::String& Text, const RF_Type::UInt32 Position,
                            StorageType* Storage);

    /// Reset the position of the cursor.
    static void Reset(RF_Type::String& Text, const RF_Type::UInt32 Position, 
                        StorageType* Storage);
