...
{
public:
    GridLayouter(Control* Parent = nullptr, const RF_Type::Size RowCount = 1, const RF_Type::Size ColumnCount = 1);
    void SetGap(const RF_Geo::Size2Df& Gap);
    void AddChild(Control& Obj, const RF_Type::Size RowIndex, const RF_Type::Size ColumnIndex);
