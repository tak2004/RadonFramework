...
public:
    ...
    virtual Dispatcher GetCustomDispatcher(const RF_Type::UInt32 Identifier)const = 0;
protected:
...
inline RF_Collect::CommandBucket<>* AbstractRenderer::GetQueue(const RF_Type::Size Index)
{
