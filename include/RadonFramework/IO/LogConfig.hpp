...
public:
  ...
  RF_Type::Bool
  ReadFromBinaryData(Memory::AutoPointerArray<RF_Type::UInt8> Data);
  ...
  Memory::AutoPointer<Collections::Array<Memory::AutoPointer<Appender>>>
  GenerateAppenders();
  ...
  static Collections::Array<Collections::Pair<RF_Type::UInt32, Appender* (*)()>>
      AppenderLookupTable;
