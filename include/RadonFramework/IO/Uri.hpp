...
public:
  ...
  RF_Type::String
  GetComponents(const UriComponents::Type Components = UriComponents::All,
  ...
  // first difference.
  static RF_Type::Int32 Compare(const Uri& Uri1,
                                const Uri& Uri2,
                                const UriComponents::Type PartToCompare,
                                const UriFormat::Type CompareFormat);

  // Converts a string to its escaped representation.
  static RF_Type::String
  EscapeDataString(const RF_Type::String& StringToEscape);

  // Converts a URI string to its escaped representation.
  static RF_Type::String EscapeUriString(const RF_Type::String& StringToEscape);
  ...
  // to the character.
  static RF_Type::Char
  HexUnescape(const RF_Type::String& Pattern, RF_Type::UInt32& Index);
  ...
  static RF_Type::Bool
  IsHexEncoding(const RF_Type::String& Pattern, const RF_Type::UInt32 Index);

  // Converts a string to its unescaped representation.
  static RF_Type::String
  UnescapeDataString(const RF_Type::String& StringToUnescape);
...
protected:
  ...
  RF_Type::String
  Escape(RF_Type::String& str, const RF_Type::String& UriString);
private:
  RF_Type::UInt8 Padding[19];
};
