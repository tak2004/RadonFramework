...
public:
  ...
  /// Return the data directory for 'current user' which belongs to the running
  /// application.
  static Memory::AutoPointer<Directory> UserApplicationDataDirectory();
  /// Return the data directory for 'all user' which belongs to the running
  /// application.
  ...
  /// This is a util function which create a Directory object and set the
  /// location.
