...
struct EncoderServiceLocator:public RF_Pattern::Locator<EncoderService, NullEncoderService>
{
    EncoderServiceLocator() = delete;

    static EncoderServiceLocator::Iterator FindCodec(
        const RF_Type::UInt32 FCC, RF_Encoders::Interface Target);

    static EncoderServiceLocator::Iterator FindByNameOrFourCC(
