...
public:
  ...
  IPAddress(const RF_Type::UInt8 IPv4Byte1,
            const RF_Type::UInt8 IPv4Byte2,
            const RF_Type::UInt8 IPv4Byte3,
            const RF_Type::UInt8 IPv4Byte4);
  IPAddress(const RF_Type::UInt16 IPv6Part1,
            const RF_Type::UInt16 IPv6Part2,
            const RF_Type::UInt16 IPv6Part3,
            const RF_Type::UInt16 IPv6Part4,
            const RF_Type::UInt16 IPv6Part5,
            const RF_Type::UInt16 IPv6Part6,
            const RF_Type::UInt16 IPv6Part7,
            const RF_Type::UInt16 IPv6Part8);
  ~IPAddress();
  ...
  static RF_Type::Bool
  IsInSameSubnet(IPAddress IP1, IPAddress IP2, IPAddress NetMask);
  ...
  static RF_Type::Bool
  Resolve(const RF_Type::String& Text, IPAddress& ResolvedAddress);
  static RF_Type::Bool
  ResolveIP4(const RF_Type::String& Text, IPAddress& ResolvedAddress);
  static RF_Type::Bool
  ResolveIP6(const RF_Type::String& Text, IPAddress& ResolvedAddress);
  static RF_Type::Bool
  ResolveIP6Hybrid(const RF_Type::String& Text, IPAddress& ResolvedAddress);
