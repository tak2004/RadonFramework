...
{
public:
  static_assert(std::is_base_of<RF_IO::Stream, CLASS>::value,
                "Have to be derived from Stream!");
...
{
  T result = Value;
  static RF_Type::Bool DifferentEndian =
      RF_Sys::CompilerConfig::Endianness != RF_Sys::Endian::Big;
  static RF_Type::Bool NeedConversion =
      (sizeof(T) == 2 || sizeof(T) == 4 || sizeof(T) == 8) && DifferentEndian;
