...
public:
  ...
  inline const RadonFramework::System::Process::TimingInfo&
  GetTimingInfo() const;
  inline const RadonFramework::System::Process::MemoryInfo&
  GetMemoryInfo() const;
  inline const RadonFramework::System::Process::IOInfo& GetIOInfo() const;
  inline const RadonFramework::System::Process::GeneralInfo&
  GetGeneralInfo() const;
  inline const RadonFramework::System::Process::ModuleInfo& GetModules() const;
  inline const RadonFramework::System::Process::ThreadInfoList&
  GetThreads() const;
...
inline const RadonFramework::System::Process::TimingInfo&
ProcessInformation::GetTimingInfo() const
{
  return this->m_TimingInfo;
}

inline const RadonFramework::System::Process::MemoryInfo&
ProcessInformation::GetMemoryInfo() const
{
  return this->m_MemoryInfo;
}

inline const RadonFramework::System::Process::IOInfo&
ProcessInformation::GetIOInfo() const
{
  return this->m_IOInfo;
}

inline const RadonFramework::System::Process::GeneralInfo&
ProcessInformation::GetGeneralInfo() const
{
  return this->m_GeneralInfo;
}

inline const RadonFramework::System::Process::ModuleInfo&
ProcessInformation::GetModules() const
{
  return this->m_Modules;
}

inline const RadonFramework::System::Process::ThreadInfoList&
ProcessInformation::GetThreads() const
{
