...
public:
    ...
    virtual const RF_Collect::Array<RF_Type::Float32>& CurrentValues(const RF_Type::Size GPUIndex)const = 0;
    virtual const RF_Collect::Array<RF_Type::Float32>& MaxValues(const RF_Type::Size GPUIndex)const = 0;
    virtual const RF_Collect::Array<RF_Type::Float32>& MinValues(const RF_Type::Size GPUIndex)const = 0;
    virtual const RF_Collect::Array<RF_Type::Bool>& AvailableValues(const RF_Type::Size GPUIndex)const = 0;
