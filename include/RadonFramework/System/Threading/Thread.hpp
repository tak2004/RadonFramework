        ...
        namespace Threading
        {
            class Thread:public RadonFramework::Threading::IRunnable,public SignalReceiver
            {
                public:
                    ...
                    void* MemAlloc(const Core::Types::UInt64 Bytes);
                    ...
                    /// a Thread instances.
                    Core::Types::Bool MemAccess(const void* Ptr);

                    /// Return the Process ID of the current thread or main process.
                    static Core::Types::Int64 CurrentPid();
                protected:
                    RadonFramework::Threading::ThreadPriority::Type m_Priority;
                    IRunnable* m_Target;
                    Core::Types::Bool m_Alive;
                    Core::Types::Bool m_CreateSuccessful;
                    Collections::AutoVector<Core::Types::UInt8> m_ThreadAllocatedMemory;
                    Mutex m_ThreadBarrier;
                    Core::Types::String m_Name;
                    Core::Types::Int64 m_Pid;
                    void* m_ImplData;
                    void Finished();
            };
        }
