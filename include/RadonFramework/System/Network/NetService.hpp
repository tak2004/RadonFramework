            ...
            class NetService
            {
                public:
                    ...
                    static Net::IPHostEntry GetHostEntry(
                        const Core::Types::String& HostnameOrAddress);

                    // Return the hostname of the pc.
                    static Core::Types::String GetHostname();
                    ...
                    static Net::Error::Type SetBlockingMode(const SocketHandler Handler,
                        const Core::Types::Bool NewValue);
                private:
                    ...
                    static Net::Error::Type GetSocketOptionWrapper(const SocketHandler Handler, 
                        const Net::SocketOptionLevel::Type OptionLevel, 
                        const Net::SocketOptionName::Type OptionName, 
                        RadonFramework::Memory::AutoPointerArray<Core::Types::UInt8>& Value);
                    ...
                    static Net::Error::Type SetSocketOption(const SocketHandler Handler, 
                        const Net::SocketOptionLevel::Type OptionLevel, 
                        const Net::SocketOptionName::Type OptionName, 
                        const void* const OptionValue, const Core::Types::UInt32 OptionLength);
            };
        }
    }
}
...
RadonFramework::Net::Error::Type
    ...
    T& OptionValue)
{
    RadonFramework::Memory::AutoPointerArray<RadonFramework::Core::Types::UInt8> arr(
        new RadonFramework::Core::Types::UInt8[sizeof(T)],sizeof(T));
