            ...
            class NetService
            {
                public:
                    ...
                    static Net::IPHostEntry GetHostEntry(
                        const RFTYPE::String& HostnameOrAddress);

                    // Return the hostname of the pc.
                    static RFTYPE::String GetHostname();
                ...
                private:
                    ...
                    static Net::Error::Type GetSocketOptionWrapper(const SocketHandler Handler, 
                        const Net::SocketOptionLevel::Type OptionLevel, 
                        const Net::SocketOptionName::Type OptionName, 
                        RadonFramework::Memory::AutoPointerArray<RFTYPE::UInt8>& Value);
                    ...
                    static Net::Error::Type SetSocketOption(const SocketHandler Handler, 
                        const Net::SocketOptionLevel::Type OptionLevel, 
                        const Net::SocketOptionName::Type OptionName, 
                        const void* const OptionValue, const RFTYPE::UInt32 OptionLength);
            };
        }
    }
}
...
RadonFramework::Net::Error::Type
    ...
    T& OptionValue)
{
    RadonFramework::Memory::AutoPointerArray<RFTYPE::UInt8> arr(
        new RFTYPE::UInt8[sizeof(T)],sizeof(T));
