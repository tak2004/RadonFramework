...
void GetNotDispatchedVec128IntFunctions(
    Collections::List<RF_Type::String>& Result);

using Vec128IntLoadCallback = void (*)(RF_Type::Vec128Int32* Destination,
                                       const RF_Type::Vec128Int32* Source,
                                       const RF_Type::Size Elements);

using Vec128IntSetInt32Callback = void (*)(RF_Type::Vec128Int32* Destination,
                                           const RF_Type::Int32 Source,
                                           const RF_Type::Size Elements);

using Vec128IntCompareInt32Callback =
    void (*)(RF_Type::Vec128Int32* Destination,
             const RF_Type::Vec128Int32* SourceA,
             const RF_Type::Vec128Int32* SourceB,
             const RF_Type::Size Elements);
...
using Vec128IntFindInt32Callback =
    RF_Type::Int32 (*)(const RF_Type::Vec128Int32* Source,
                       RF_Type::Int32 Value);
